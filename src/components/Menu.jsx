...
function Menu() {
    return (
        <section id='menu'>
            ...
            <Link to='performance'><button id='performace' className='menuButton'>Performance Metrics</button></Link>
            <Link to='userContainer'><button id='userContainer' className='menuButton'>Create Dashboard</button></Link>
